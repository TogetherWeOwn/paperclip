...
gh pr create \
  --title "docs: update documentation for accuracy" \
  --body "$(cat <<'EOF'
## Why
Documentation drift makes the published instructions inaccurate.

## What
- [list each fix]

## Validation
- [list the checks that prove each factual correction]

## Risk and rollback
Low risk. Revert this documentation commit to roll back.
...
## References
- [public issue, runbook, release, or "Not applicable"]
EOF
)"
```
